...
Es werden sowohl die subjektiv beschreibenden Kriterien angegeben, als auch die objektiv messbaren Kriterien, die mit einer  gefunden wurden. In diesem Fall hängt die Pain Score von der Durchschnittslänge der Cry-Units des Segmentes $mean_{cu}(cs)$ ab (giehe Gleichung \ref{eq:featuresOfCryUnits}).
...
Mit Hilfe der in Kapitel \ref{sec:deduction} beschriebenen Strategien wurde die Funktion $PS_{Fiction}$ ermittelt, definiert in Gleichung \ref{eq:ps_fiction}, welche die Ableitung des Schmerz Score für eine Cry-Segment mit Hilfe objektiv messbarer Features erlaubt.
