...
\begin{figure}[H]
	...
	\caption[ormanten im Sprach-Signal]{Formanten im Sprach-Signal (nach: \cite{benade})}
	\label{img:formants}
\end{figure}	
...
Es gibt diverse Gründe, die bei Neugeborenen Schmerz verursachen können. Sie reichen über physische Schäden, beispielsweise aufgrund von Komplikationen bei der Geburt oder Gewalteinwirkungen, über Erkrankungen, wie Kopfschmerzen oder Infektionen, bis hin zu therapeutischen Prozeduren, wie Injektionen oder Desinfektionen von Wunden. Das Vorhandensein von Schmerz ist anhand diverser physiologischer, biochemischer, verhaltensbezogener und psychologischer Veränderungen messbar. Die für diese Arbeit wichtigste Verhaltensänderung ist das Weinen, welche zu den verhaltensbezogenen Veränderungen zählt.\cite[S. 441]{PainAssessment01} 
